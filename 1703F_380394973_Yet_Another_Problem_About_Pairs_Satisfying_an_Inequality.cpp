// Codeforces Problem: 1703F - Yet Another Problem About Pairs Satisfying an Inequality
// Submission ID: 380394973
...
// Problem: F_Yet_Another_Problem_About_Pairs_Satisfying_an_Inequality
// Rating: Rating
// =============================================================
...
ll modMul(ll a, ll b) { return ((a % MOD) * (b % MOD)) % MOD; }
 void solve() {
     ...
     for1(j, n) 
    {
        if (a[j] < j) 
        {
            int count = lower_bound(all(valid), a[j]) - valid.begin();
            ans += count;
        }
    }
     cout << ans << '\n';
