// Codeforces Problem: 1734C - Removing Smallest Multiples
// Submission ID: 379532036
...
// Problem: Removing_Smallest_Multiples
// Rating: Rating
// =============================================================
...
;
void reverse_seive(vector<bool> &a , int n , vector<int> &cost )
{
    for1n(i,n)
    {
        for(int j = i ; j <= n ; j+=i) 
